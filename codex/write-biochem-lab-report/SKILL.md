...
```powershell
python "$env:USERPROFILE\.codex\skills\write-biochem-lab-report\scripts\create_report_project.py" "D:\path\to\report" --title "Protein Quantification Report" --name "Name" --student-id "2023000000" --class-name "Class" --date "May 28, 2026"
```
...
```powershell
python "$env:USERPROFILE\.codex\skills\write-biochem-lab-report\scripts\check_report_tex.py" .\report.tex
```
