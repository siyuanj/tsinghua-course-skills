...
python "$env:USERPROFILE\.claude\skills\yuketang-replay-downloader\scripts\batch_yuketang_replays.py" --help
```
...
```powershell
$skill = "$env:USERPROFILE\.claude\skills\yuketang-replay-downloader"
